...
namespace SurveyBasket.Api.Services
{
    public interface IQuestionService
    {
        ...
        Task<Result<QuestionResponse>> AddAsync( int pollId, QuestionsRequest request,CancellationToken cancellationToken = default);
        Task<Result> UpdateAsync(int pollId, int id, QuestionsRequest request, CancellationToken cancellation = default);
